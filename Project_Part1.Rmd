...
-   Our markdown document can be found [here](https://bu-ie-423.github.io/fall-23-alpemretoken/Project_Part1.Rmd).
-   The data used in this study can be found [here](https://bu-ie-423.github.io/fall-23-alpemretoken/part1_Data.zip)
...
# Import long data
data_long <- read.csv("all_ticks_long.csv")
...
# Import data
data_wide <- read.csv("all_ticks_wide.csv")
