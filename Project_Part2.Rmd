...
-   Our markdown document can be found [here](https://bu-ie-423.github.io/fall-23-alpemretoken/Project_Part2.Rmd).
-   The data used in this study can be found [here](https://bu-ie-423.github.io/fall-23-alpemretoken/Data/part2_Data.zip)
...
```
geom_line(aes(x = timestamp, y = price, color = short_name)) + labs(title = "The Given Stock Data")
